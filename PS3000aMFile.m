...
%This function was generated by loadlibrary.m parser version  on Wed Nov 26 14:10:30 2014
...
fcns.name{fcnNum}='ps3000aMemorySegments'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'uint32', 'int32Ptr'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aSetDigitalPort'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'enPS3000ADigitalPort', 'int16', 'int16'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aSetNoOfCaptures'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'uint32'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aGetTimebase'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'uint32', 'int32', 'int32Ptr', 'int16', 'int32Ptr', 'uint32'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aGetTimebase2'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'uint32', 'int32', 'singlePtr', 'int16', 'int32Ptr', 'uint32'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aSetSigGenArbitrary'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'int32', 'uint32', 'uint32', 'uint32', 'uint32', 'uint32', 'int16Ptr', 'int32', 'enPS3000ASweepType', 'enPS3000AExtraOperations', 'enPS3000AIndexMode', 'uint32', 'uint32', 'enPS3000ASigGenTrigType', 'enPS3000ASigGenTrigSource', 'int16'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aSetSigGenBuiltIn'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'int32', 'uint32', 'int16', 'single', 'single', 'single', 'single', 'enPS3000ASweepType', 'enPS3000AExtraOperations', 'uint32', 'uint32', 'enPS3000ASigGenTrigType', 'enPS3000ASigGenTrigSource', 'int16'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aSetSigGenBuiltInV2'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'int32', 'uint32', 'int16', 'double', 'double', 'double', 'double', 'enPS3000ASweepType', 'enPS3000AExtraOperations', 'uint32', 'uint32', 'enPS3000ASigGenTrigType', 'enPS3000ASigGenTrigSource', 'int16'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aSetSigGenPropertiesArbitrary'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'uint32', 'uint32', 'uint32', 'uint32', 'enPS3000ASweepType', 'uint32', 'uint32', 'enPS3000ASigGenTrigType', 'enPS3000ASigGenTrigSource', 'int16'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aSetSigGenPropertiesBuiltIn'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'double', 'double', 'double', 'double', 'enPS3000ASweepType', 'uint32', 'uint32', 'enPS3000ASigGenTrigType', 'enPS3000ASigGenTrigSource', 'int16'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aSigGenFrequencyToPhase'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'double', 'enPS3000AIndexMode', 'uint32', 'uint32Ptr'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aSigGenArbitraryMinMaxValues'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'int16Ptr', 'int16Ptr', 'uint32Ptr', 'uint32Ptr'};fcnNum=fcnNum+1;
% PICO_STATUS _stdcall ps3000aGetMaxEtsValues ( int16_t handle , int16_t * etsCycles , int16_t * etsInterleave ); 
fcns.name{fcnNum}='ps3000aGetMaxEtsValues'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'int16Ptr', 'int16Ptr'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aSetEts'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'enPS3000AEtsMode', 'int16', 'int16', 'int32Ptr'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aSetSimpleTrigger'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'int16', 'enPS3000AChannel', 'int16', 'enPS3000AThresholdDirection', 'uint32', 'int16'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aSetTriggerDigitalPortProperties'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'tPS3000ADigitalChannelDirectionsPtr', 'int16'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aSetPulseWidthDigitalPortProperties'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'tPS3000ADigitalChannelDirectionsPtr', 'int16'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aSetTriggerChannelProperties'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'tPS3000ATriggerChannelPropertiesPtr', 'int16', 'int16', 'int32'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aSetTriggerChannelConditionsV2'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'tPS3000ATriggerConditionsV2Ptr', 'int16'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aSetTriggerDelay'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'uint32'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aSetPulseWidthQualifier'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'tPS3000APwqConditionsPtr', 'int16', 'enPS3000AThresholdDirection', 'uint32', 'uint32', 'enPS3000APulseWidthType'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aSetPulseWidthQualifierV2'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'tPS3000APwqConditionsV2Ptr', 'int16', 'enPS3000AThresholdDirection', 'uint32', 'uint32', 'enPS3000APulseWidthType'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aGetTriggerTimeOffset'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'uint32Ptr', 'uint32Ptr', 'enPS3000ATimeUnitsPtr', 'uint32'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aGetTriggerTimeOffset64'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'int64Ptr', 'enPS3000ATimeUnitsPtr', 'uint32'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aGetValuesTriggerTimeOffsetBulk'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'uint32Ptr', 'uint32Ptr', 'uint32Ptr', 'uint32', 'uint32'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aGetValuesTriggerTimeOffsetBulk64'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'int64Ptr', 'uint32Ptr', 'uint32', 'uint32'};fcnNum=fcnNum+1;
% PICO_STATUS _stdcall ps3000aGetNoOfCaptures ( int16_t handle , uint32_t * nCaptures ); 
fcns.name{fcnNum}='ps3000aGetNoOfCaptures'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'uint32Ptr'};fcnNum=fcnNum+1;
% PICO_STATUS _stdcall ps3000aGetNoOfProcessedCaptures ( int16_t handle , uint32_t * nProcessedCaptures ); 
fcns.name{fcnNum}='ps3000aGetNoOfProcessedCaptures'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'uint32Ptr'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aSetDataBuffer'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'enPS3000AChannel', 'int16Ptr', 'int32', 'uint32', 'enPS3000ARatioMode'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aSetDataBuffers'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'enPS3000AChannel', 'int16Ptr', 'int16Ptr', 'int32', 'uint32', 'enPS3000ARatioMode'};fcnNum=fcnNum+1;
% PICO_STATUS _stdcall ps3000aSetEtsTimeBuffer ( int16_t handle , int64_t * buffer , int32_t bufferLth ); 
fcns.name{fcnNum}='ps3000aSetEtsTimeBuffer'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'int64Ptr', 'int32'};fcnNum=fcnNum+1;
% PICO_STATUS _stdcall ps3000aSetEtsTimeBuffers ( int16_t handle , uint32_t * timeUpper , uint32_t * timeLower , int32_t bufferLth ); 
fcns.name{fcnNum}='ps3000aSetEtsTimeBuffers'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'uint32Ptr', 'uint32Ptr', 'int32'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aRunBlock'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'int32', 'int32', 'uint32', 'int16', 'int32Ptr', 'uint32', 'voidPtr', 'voidPtr'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aRunStreaming'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'uint32Ptr', 'enPS3000ATimeUnits', 'uint32', 'uint32', 'int16', 'uint32', 'enPS3000ARatioMode', 'uint32'};fcnNum=fcnNum+1;
% PICO_STATUS _stdcall ps3000aGetStreamingLatestValues ( int16_t handle , void * lpPs3000aReady , void * pParameter ); 
fcns.name{fcnNum}='ps3000aGetStreamingLatestValues'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'voidPtr', 'voidPtr'};fcnNum=fcnNum+1;
% PICO_STATUS _stdcall ps3000aNoOfStreamingValues ( int16_t handle , uint32_t * noOfValues ); 
fcns.name{fcnNum}='ps3000aNoOfStreamingValues'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'uint32Ptr'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aGetMaxDownSampleRatio'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'uint32', 'uint32Ptr', 'enPS3000ARatioMode', 'uint32'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aGetValues'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'uint32', 'uint32Ptr', 'uint32', 'enPS3000ARatioMode', 'uint32', 'int16Ptr'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aGetValuesBulk'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'uint32Ptr', 'uint32', 'uint32', 'uint32', 'enPS3000ARatioMode', 'int16Ptr'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aGetValuesAsync'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'uint32', 'uint32', 'uint32', 'int16', 'uint32', 'voidPtr', 'voidPtr'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aGetValuesOverlapped'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'uint32', 'uint32Ptr', 'uint32', 'enPS3000ARatioMode', 'uint32', 'int16Ptr'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aGetValuesOverlappedBulk'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'uint32', 'uint32Ptr', 'uint32', 'enPS3000ARatioMode', 'uint32', 'uint32', 'int16Ptr'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aGetTriggerInfoBulk'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'tPS3000ATriggerInfoPtr', 'uint32', 'uint32'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='ps3000aGetMaxSegments'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'int16', 'uint32Ptr'};fcnNum=fcnNum+1;
...
structs.tPS3000ATriggerInfo.members=struct('status', 'ulong', 'segmentIndex', 'uint32', 'reserved0', 'uint32', 'triggerTime', 'int64', 'timeUnits', 'int16', 'reserved1', 'int16', 'timeStampCounter', 'uint64');
